...
((123387-sum(pds_new_all_MD$tot_keep_sf))/123387)*100

sum(pds_new_all_MD$tot_rel_sf)
((724047-sum(pds_new_all_MD$tot_rel_sf))/724047)*100

sum(pds_new_all_MD$tot_sf_catch)
((847434-sum(pds_new_all_MD$tot_sf_catch))/847434)*100



sum(pds_new_all_MD$tot_keep_bsb)
((212050-sum(pds_new_all_MD$tot_keep_bsb))/212050)*100

sum(pds_new_all_MD$tot_rel_bsb)
((3559416-sum(pds_new_all_MD$tot_rel_bsb))/3559416)*100

sum(pds_new_all_MD$tot_bsb_catch)
((3771466-sum(pds_new_all_MD$tot_bsb_catch))/3771466)*100



sum(pds_new_all_MD$tot_keep_scup)
((256-sum(pds_new_all_MD$tot_keep_scup))/256)*100

sum(pds_new_all_MD$tot_rel_scup)
((474-sum(pds_new_all_MD$tot_rel_scup))/474)*100

sum(pds_new_all_MD$tot_scup_catch)
((730-sum(pds_new_all_MD$tot_scup_catch))/730)*100
