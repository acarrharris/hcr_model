...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_25.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_44.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_9.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_36.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_34.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
sf_cat <- observed_catch_data$sf_tot_cat
bsb_cat <- observed_catch_data$bsb_tot_cat
scup_cat <- observed_catch_data$scup_tot_cat
...
####################
#Delaware
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_10.csv"), select=c(sf_tot_cat, bsb_tot_cat))
sf_cat <- observed_catch_data$sf_tot_cat
bsb_cat <- observed_catch_data$bsb_tot_cat
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_24.csv"), select=c(sf_tot_cat, bsb_tot_cat))
sf_cat <- observed_catch_data$sf_tot_cat
bsb_cat <- observed_catch_data$bsb_tot_cat
...
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_51.csv"), select=c(sf_tot_cat, bsb_tot_cat, scup_tot_cat))
sf_cat <- observed_catch_data$sf_tot_cat
bsb_cat <- observed_catch_data$bsb_tot_cat
scup_cat <- observed_catch_data$scup_tot_cat
...
####################
#North Carolina
observed_catch_data <- subset(read.csv("observed_catch_2018_2022_37.csv"), select=c(sf_tot_cat, bsb_tot_cat))
sf_cat <- observed_catch_data$sf_tot_cat
bsb_cat <- observed_catch_data$bsb_tot_cat
