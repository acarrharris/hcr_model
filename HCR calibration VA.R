...
((221123-sum(pds_new_all_VA$tot_keep_sf))/221123)*100

sum(pds_new_all_VA$tot_rel_sf)
((1364890-sum(pds_new_all_VA$tot_rel_sf))/1364890)*100

sum(pds_new_all_VA$tot_sf_catch)
((1586013-sum(pds_new_all_VA$tot_sf_catch))/1586013)*100



sum(pds_new_all_VA$tot_keep_bsb)
((444313-sum(pds_new_all_VA$tot_keep_bsb))/444313)*100

sum(pds_new_all_VA$tot_rel_bsb)
((2984018 -sum(pds_new_all_VA$tot_rel_bsb))/2984018)*100

sum(pds_new_all_VA$tot_bsb_catch)
((3428331-sum(pds_new_all_VA$tot_bsb_catch))/3428331)*100



sum(pds_new_all_VA$tot_keep_scup)
((128056-sum(pds_new_all_VA$tot_keep_scup))/128056)*100

sum(pds_new_all_VA$tot_rel_scup)
((34066-sum(pds_new_all_VA$tot_rel_scup))/34066)*100

sum(pds_new_all_VA$tot_scup_catch)
((162122-sum(pds_new_all_VA$tot_scup_catch))/162122)*100
