...
((1349631-sum(pds_new_all_NJ$tot_keep_sf))/1349631)*100

sum(pds_new_all_NJ$tot_rel_sf)
((11933487-sum(pds_new_all_NJ$tot_rel_sf))/11933487)*100

sum(pds_new_all_NJ$tot_sf_catch)
((13283118-sum(pds_new_all_NJ$tot_sf_catch))/13283118)*100



sum(pds_new_all_NJ$tot_keep_bsb)
((1929157-sum(pds_new_all_NJ$tot_keep_bsb))/1929157)*100

sum(pds_new_all_NJ$tot_rel_bsb)
((8884482 	-sum(pds_new_all_NJ$tot_rel_bsb))/8884482)*100

sum(pds_new_all_NJ$tot_bsb_catch)
((10813639-sum(pds_new_all_NJ$tot_bsb_catch))/10813639)*100



sum(pds_new_all_NJ$tot_keep_scup)
((153171-sum(pds_new_all_NJ$tot_keep_scup))/153171)*100

sum(pds_new_all_NJ$tot_rel_scup)
((204731-sum(pds_new_all_NJ$tot_rel_scup))/204731)*100

sum(pds_new_all_NJ$tot_scup_catch)
((357902-sum(pds_new_all_NJ$tot_scup_catch))/357902)*100
